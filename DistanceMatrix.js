...
window.initMap = function()
{
  ...
  var mapOptions =
  {
    center: new google.maps.LatLng(51.315875, 9.494597), //münchen
    zoom: 5
  };
  ...
  geocoder.geocode({'address': origin}, function(results, status)
  {
    console.log('beginne geocodierung');
      if (status === google.maps.GeocoderStatus.OK) //hier passiert die magic
      {
        ...
        console.log('map zentrieren und marker auf die origin setzen');
              ...
              service.getDistanceMatrix({
                ...
                if (status !== google.maps.DistanceMatrixStatus.OK) {
                  alert('Error was: ' + status);
                    ...
                    //Car
                    console.log('Beginne mit getDistanceMatrix Driving');
                    service.getDistanceMatrix({
                      origins: [origin],
                      destinations: destinationsLatLng,
